                    ...
                    <div className="flex items-center justify-between mt-auto pt-4 gap-2">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                            ...
                            <button
                                onClick={(e) => {
                                    e.stopPropagation();
                                    window.open(`https://wa.me/6281234567890?text=Halo%20KayuManis%20Bakery,%20saya%20mau%20pesan%20${encodeURIComponent(product.name)}`, '_blank');
                                }}
                                className="p-2 text-green-600 hover:text-white hover:bg-green-500 rounded-full transition focus:outline-none bg-green-50"
